...
func generateMarkdown(templates *template.Template, role, resumeDir, audience string) {
	vars := TemplateVars{
		Resume:    "https://github.com/skyzyx/resume-jessika-parman/blob/master/resumes/" + fileNames[role],
		ResumeDir: "https://github.com/skyzyx/resume-jessika-parman/blob/master/resumes/",
		ResumeRaw: "https://github.com/skyzyx/resume-jessika-parman/raw/master/resumes/" + fileNames[role],
	}
